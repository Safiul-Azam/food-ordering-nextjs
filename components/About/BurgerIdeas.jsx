  ...
  return (
    ...
    >
      <div className="space-y-6 w-11/12">
        ...
        <h2 className="text-5xl text-[#1E1D23] font-extrabold">
      ...
      <div className="w-full lg:flex   space-x-4">
        <div className="">
          <Image
            width={280}
            height={440}
            className=" rounded-md hover:-translate-y-2 hover:duration-300 hover:ease-in-out ease-in-out duration-300 "
            src="https://i.ibb.co/Z86cJWL/image1-h4.jpg"
            alt=""
          />
        </div>
        <div className="space-y-2">
          <div>
            <Image
              ...
              height={250}
              className="rounded-md hover:-translate-y-2 hover:duration-300 hover:ease-in-out ease-in-out duration-300"
              src="https://i.ibb.co/9TvFf2X/image2-h4.jpg"
              alt=""
            />
          </div>
          <div className="">
            <Image
              ...
              height={350}
              className="rounded-md hover:-translate-y-2 hover:duration-300 hover:ease-in-out ease-in-out duration-300"
              src="https://i.ibb.co/L9n7M1z/image3-h4.jpg"
              alt=""
            />
          </div>
        </div>
